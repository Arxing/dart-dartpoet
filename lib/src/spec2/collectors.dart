...
String _collectWithDoc(DocumentSpec doc, String raw) {
...
String _collectMetas(List<AnnotationSpec> metas) {
  return metas.map((o) => o.code()).join('\n');
}

String _collectWithMeta(List<AnnotationSpec> metas, String raw) {
