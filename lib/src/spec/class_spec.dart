...
class ClassSpec extends Spec {
  DocSpec get doc => _childrenWhereKind(SpecKind.DOC).single;

  List<MetaSpec> get metas => _childrenWhereKind(SpecKind.META);

  List<GetterSpec> get getters => _childrenWhereKind(SpecKind.GETTER);

  List<SetterSpec> get setters => _childrenWhereKind(SpecKind.SETTER);

  List<MethodSpec> get methods => _childrenWhereKind(SpecKind.METHOD);

  List<ConstructorSpec> get constructors => _childrenWhereKind(SpecKind.CONSTRUCTOR);

  List<PropertySpec> get properties => _childrenWhereKind(SpecKind.PROPERTY);

  List<OperatorSpec> get operatorMethods => _childrenWhereKind(SpecKind.OPERATOR);
